 ...
 * <p>Author: weiser
 *
 * <p>Creation Date: 18.08.2010
 *
 * <p>Completion Time: 18.08.2010
 *
 * <p>*****************************************************************************
 */
...
/** @author weiser */
@WebService(
    serviceName = "MockOperationService",
    targetNamespace = "http://oscm.org/xsd",
    portName = "MockOperationServicePort",
    endpointInterface = "org.oscm.operation.intf.OperationService")
public class OperationServiceBean implements OperationService {
  ...
  private RequestLogEntry createLogEntry(String title) {
    ...
    final RequestLogEntry entry =
        log.createEntry(
            OperationService.class.getSimpleName() + "." + title, RequestDirection.INBOUND);
