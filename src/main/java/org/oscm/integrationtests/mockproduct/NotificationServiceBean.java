 ...
 */
@WebService(
    serviceName = "MockNotificationService",
    targetNamespace = "http://oscm.org/xsd",
    portName = "MockNotificationServicePort",
...
public class NotificationServiceBean implements NotificationService {
  ...
  private RequestLogEntry createLogEntry() {
    ...
    final RequestLogEntry entry =
        log.createEntry(
            NotificationService.class.getSimpleName() + "." + getMethodName(),
  ...
  private void addQuickLinks(final RequestLogEntry entry, VOTriggerProcess triggerProcess) {
    QuickLink link;
  ...
  @Override
  public void onActivateProduct(VOTriggerProcess triggerProcess, VOService product) {
    final RequestLogEntry entry = createLogEntry();
  ...
  @Override
  public void onDeactivateProduct(VOTriggerProcess triggerProcess, VOService product) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
    entry.addParameter("product", product);
    addQuickLinks(entry, triggerProcess);
  ...
  public void onModifySubscription(
      ...
      List<VOParameter> modifiedParameters) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  @Override
  public void onRemoveSupplier(VOTriggerProcess triggerProcess, String supplierId) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
    entry.addParameter("supplierId", supplierId);
    addQuickLinks(entry, triggerProcess);
  ...
  public void onSaveDefaultPaymentConfiguration(
      VOTriggerProcess triggerProcess, Set<VOPaymentType> defaultConfiguration) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  public void onSaveCustomerPaymentConfiguration(
      VOTriggerProcess triggerProcess, VOOrganizationPaymentConfiguration customerConfiguration) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  @Override
  public void onUnsubscribeFromProduct(VOTriggerProcess triggerProcess, String subId) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  public void onUpgradeSubscription(
      VOTriggerProcess triggerProcess, VOSubscription current, VOService newProduct) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  public void onSaveServicePaymentConfiguration(
      VOTriggerProcess triggerProcess, VOServicePaymentConfiguration serviceConfiguration) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  public void onSubscriptionModification(
      VOTriggerProcess triggerProcess, List<VOParameter> parameters, VONotification notification) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
  ...
  public void onSubscriptionTermination(
      VOTriggerProcess triggerProcess, VONotification notification) {
    final RequestLogEntry entry = createLogEntry();
    entry.addParameter("triggerProcess", triggerProcess);
    entry.addParameter("notification", notification);
    addQuickLinks(entry, triggerProcess);
